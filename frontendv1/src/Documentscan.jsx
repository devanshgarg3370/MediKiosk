...
function DocumentScan({ back, next }) {
    ...
    <div className="page">
      ...
      <main className="main">
        ...
        <div className="titleRow">
          <div>
            <p className="welcome">● MEDICAL DOCUMENTS</p>

            <h1>Have any medical<br />documents?</h1>
        ...
        <section className="documentCard">
          ...
          <div className="documentTypes">
            ...
            <button
              ...
              onClick={() => setCategory("Discharge Summary")}
            >
              <span>🏥</span>
          ...
          <div className="scanArea">
            ...
            <p>
              Place your document clearly in front of the camera
            </p>
